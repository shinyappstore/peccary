  ...
  dashboardBody(
    ...
    do.call(tabItems, append(list(
      ...
      tabItem(tabName = "Welcome",
              ...
              br("For tutorials, you can find:"),
              "+", tags$a(href="https://github.com/Peccary-PMX/Peccary/releases/download/Doc/Peccary_Documentation.html", "a html document (click to download)", target="_blank" ),
              br(),
              "+", tags$a(href = "https://www.youtube.com/watch?v=d77c4v2_jcw", "Youtube videos (click to open)"),
              h3("Load Project"),
